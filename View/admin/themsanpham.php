    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                Thêm sản phầm nào <?php echo $Admin->gethoten();?>
            </li>
        ...
        if(isset($_POST['themmoi'])){
            ...
            if(isset($_POST['tensanpham']) && isset($_POST['giasanpham']) && isset($_POST['loaisanpham']) && $_FILES['img']['size'] != ""){
                ...
                $idadmin = $Admin->getID();
                $query1 = "INSERT INTO hanghoa(idadminh,idloaisanpham,giasanpham,tensanpham,anhminhhoa)
                                          VALUES ('$idadmin','$loaisanpham','$giasanpham','$tensanpham','$link_img')";
