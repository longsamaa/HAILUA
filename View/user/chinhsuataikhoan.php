        ...
        <div class="col-lg-9">
            ...
            <?php
                if(isset($_POST['chinhsua'])){
                    if(empty($_POST['hoten']) || empty($_POST['sodt'])){
                        echo "<p style='color: red'>Làm ơn hãy nhập đủ thông tin</p>";
                    }
                    else {
            ...
            <div class="mx-auto">
            <form method="post">
                <label class="card-title">Họ tên</label>
                <input type="text" name="hoten" class="form-control" placeholder="Họ tên" autofocus="autofocus" value="<?php echo $thongtin['hoten']; ?>">
                <?php echo "</br>" ?>
                <label class="card-title">Số điện thoại</label>
                <input type="text" name="sodt" class="form-control" placeholder="Số điện thoại" value="<?php echo $thongtin['sodienthoai'] ?>">
                <?php echo '</br>' ?>
                <input type="submit" name = "chinhsua" value="Chỉnh sửa" class="btn-dark">
            </form>
